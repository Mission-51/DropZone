...
public class PlayerAttack_Punk : MonoBehaviour, IAttack
{
    ...
    public float knockbackForce = 10.0f; // 넉백의 힘
    ...
    void Awake()
    {
        ...
        // PhotonView가 필요: 공격과 스킬 사용 상태를 다른 클라이언트에 동기화해야 함
    }
    ...
    void Update()
    {
        ...
        // 스킬 사용은 네트워크 동기화가 필요하므로 PhotonView와 RPC 사용이 필요함
    ...
    public void GetAttackInput(bool fDown)
    {
        ...
        {
            StartAttack();
            // 공격 동작은 다른 클라이언트에 동기화되어야 하므로 RPC 사용 필요
        }
    }
